        ...
        with tf.Session(config=self.tf_config) as sess:
            ...
            for epoch in range(self.model.n_epochs):
                ...
                for train_batch_dict in train_batch_gen:
                    ...
                    ops = [self.model.y_T, self.model.y_T_,  self.model.loss, self.model.optimize,
                           self.model.global_step, self.model.causal_consistency_loss, self.model.alpha_i, self.model.omega_i]
                    train_batch_y, train_batch_y_,  train_batch_loss, _, n_iter, causal_loss_val, alpha_i_val, omega_i_val = sess.run(ops, feed_dict)
