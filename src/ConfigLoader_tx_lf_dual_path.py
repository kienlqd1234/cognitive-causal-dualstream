...
# logger
logger = logging.getLogger('model_logger_tx_lf_dual_path')  # Use a unique name for the dual path model
...
if not logger.hasHandlers():
    ...
    log_fp = os.path.join(path_parser.log, 'model_tx_lf_dual_path.log')  # Use a unique log file name for dual path model
